...
- 캔버스는 흰색(#ffffff), 히어로·메타 카드는 밝은 패널(#f7f7f5) + 헤어라인 테두리(#d6d6d2), 카드는 흰색(#ffffff)에 헤어라인 테두리만, 하단 띠 없음(2026-09-06). 카드 미디어는 16:9(루프 영상이 잘리지 않게, 활동 카드도 동일). 스페셜 프로젝트·TE의 재질감.
