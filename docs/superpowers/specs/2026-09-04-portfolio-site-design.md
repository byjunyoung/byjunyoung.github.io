...
### 스타일 방향
- 바탕은 흰색~연회색, 텍스트는 near-black. 색은 미디어가 낸다.
- 타이포는 작고 조용하게. 큰 타이포·장식 없음.
- 모션은 루프 영상뿐. 스크롤 애니메이션 없음.
...
- 활동 3개(uxeed, dino, internview) 본문이 프레이머에 초안으로 있는지
- 프레이머 사이트를 유지할지, 새 주소로 안내만 남길지
