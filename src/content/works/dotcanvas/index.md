...
리서치 결과를 바탕으로 닷 캔버스 웹과 앱의 화면을 Figma로 설계하고 GUI를 디자인했습니다. 교사와 시각장애 학생이 함께 쓰는 인터페이스라, UI 구조와 기능 배치를 그 둘에 맞춰 정리했습니다.
...
화면 설계서와 기능 명세서를 문서화하고 JIRA로 이슈를 관리했습니다. 개발팀과 기술적 변경을 맞추며 기능 개선과 출시 일정을 조율했습니다.
...
![CSUN 2023 부스에서 방문자가 닷패드의 촉각 그래픽을 만져 보는 모습](./17.jpg)
